...
public class CalendarEvent {
	...
	public CalendarEvent(Date beginTime, Date endTime, boolean allDay, String description) {
		this();
	...
	public CalendarEvent(long beginTime, long endTime, boolean allDay, String description) {
	...
	public boolean matchesBeginTime(long millis) {
		...
		if((target.getMonth() == mBeginTime.getMonth() &&
				...
				target.getYear() == mBeginTime.getYear() &&
				target.getHours() == mBeginTime.getHours()) && 
